...
if __name__ == "__main__":
    ...
    fname = "raw_data/1116xm130ym830WTp03.v3.hei_dense.txt"
    ...
    ax_zerfit = cb.image_plot(fig, "zernike(1~" +str(zer_fit_order) + ") fitting",
                              322, fit*mask*1e3, fit*mask*1e3)
    
    ax_zer03 = cb.image_plot(fig, "zernike(<="+str(3)+")",
                             323, zer03mesh*mask, zer03mesh*mask)
    ax_zer10 = cb.image_plot(fig, "zernike(<="+str(zer_fit_order)+")",
