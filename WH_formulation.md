...
新たにWH駆動量ベクトル $\vec{x} ^T \equiv (x _1, \cdots, x _{33})$ を定義する。これは、 $\vec{y}$ のうち縮退が生じているモーターの駆動量である $y _{6}$ と $y _{12}$ 、 $y _{18}$ と $y _{24}$ 、 $y _{30}$ と $y _{36}$ をそれぞれまとめたものである。以下に $\vec{x} ^T \equiv (x _1, \cdots, x _{33})$ と $\vec{y} ^T \equiv (y _1, \cdots, y _{36})$ の対応関係を示す。
